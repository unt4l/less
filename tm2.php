      ...
      <div class="form-horizontal">
        <div class="form-group">
            ...
            <select class="" name="kelas">
              ...
              <option value="<?=$v = $a['id_spp']?>"><?=$a['kelas']?></option>
              <?php endwhile; ?>
            </select>
            <input type="submit" name="plh" value="pilih">
            <?php if(isset($_POST['kelas'])){
              $v = $_POST['kelas'];
              $nil = mak($v);
              while ($rw = mysqli_fetch_assoc($nil)) {
                $value = $rw['mak'];
                $pd = number_format($rw['pendaftaran']);
                $sp = number_format($rw['spp']);
                $ks = number_format($rw['kas']);
                $krt = number_format($rw['kartu_spp']);
                $s1 = number_format($rw['seragam']);
                $s2 = number_format($rw['seragam_muslim']);
                $b1 = number_format($rw['buku_paket']);
                $b2 = number_format($rw['buku_pr']);
                $b3 = number_format($rw['lks']);
                $s3 = number_format($rw['kaos']);
                $t = number_format($rw['total']);
                if($value<10){
                  $value = date('Y').$v.'00'.$value;
                }else {
                  $value = date('Y').$v.'0'.$value;
                }
              }
            } ?>
            </div>
  ...
  <div class="panel panel-default col-sm-6">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-3">
              <input class="form-control" type="text" name="nis" disabled="" value="<?=$value;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="dft">Pendaftaran :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="dft" disabled="" value="<?=$pd;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="spp">SPP :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="spp" disabled="" value="<?=$sp;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="kas">Kas :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="kas" disabled="" value="<?=$ks;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="krt">Kartu SPP :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="krt_spp" disabled="" value="<?=$krt;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="seragam">Seragam :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="seragam" disabled="" value="<?=$s1;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="sm">Seragam Muslim :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="seragam_muslim" disabled="" value="<?=$s2;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="kaos">Kaos :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="kaos" disabled="" value="<?=$s3;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="lks">LKS :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="lks" disabled="" value="<?=$b3;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="bp">Buku Paket :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="buku_paket" disabled="" value="<?=$b1;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="pr">Buku PR :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="buku_pr" disabled="" value="<?=$b2;?>">
          </div>
      </div><br></br>
      <div class="form-group">
          <label class="control-label col-sm-3" for="tot">Total Biaya :</label>
          <div class="col-sm-3">
              <input class="form-control" type="text" name="tot" disabled="" value="<?=$t;?>">
          </div>
      </div><br></br>
      <div class="form-group">
